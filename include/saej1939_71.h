 ...
 *
 * Broadcast message:
 * 65251 - Engine configuration EC
 * 65280 (propritary) - 400B! -> 0x17(cluster)
 */
/**
 * \struct spns65251 (FEE3)
 ...
 */
struct spns65251 {
    unsigned short spn188  ; /*!< Engine speed at idle, point 1, 0.125rpm/bit, 0 offset */
    unsigned char  spn539  ; /*!< Percent torque at idel, point 1, 1%/bit, -125% offset */
    unsigned short spn528  __attribute__((packed)); /*!< Engine speed at point 2, 0.125rpm/bit, 0 offset - end of green zone */
    unsigned char  spn540  ; /*!< Percent torque at point 2, 1%/bit, -125% offset */
    unsigned short spn529  __attribute__((packed)); /*!< Engine speed at point 3, 0.125rpm/bit, 0 offset - start of green zone */
    unsigned char  spn541  ; /*!< Percent torque at point 3, 1%/bit, -125% offset */
    unsigned short spn530  __attribute__((packed)); /*!< Engine speed at point 4, 0.125rpm/bit, 0 offset */
    unsigned char  spn542  ; /*!< Percent torque at point 4, 1%/bit, -125% offset */
    unsigned short spn531  __attribute__((packed)); /*!< Engine speed at point 5, 0.125rpm/bit, 0 offset */
    unsigned char  spn543  ; /*!< Percent torque at point 5, 1%/bit, -125% offset */
    unsigned short spn532  __attribute__((packed)); /*!< Engine speed at high idel, point 6, 0.125rpm/bit, 0 offset */
    ...
    unsigned short spn533  __attribute__((packed)); /*!< Max momentary eng overspeed, point 7 0.125rpm/bit, 0 offset - start of red zone */
    ...
    /* unsigned short spn1712 __attribute__((packed)); */ /*!< Ext range req spd ctrl range upper limit, 0.125rpm/bit, 0 offset */
...
/**
 * \struct spns65262 (FEEE)
 * \brief PGN 65262 - Engine Temperature 1 - ET1
 *
...
struct spns65265 {
    ...
    unsigned char u0      : 2; /*!< unused, filled with 1's */
    unsigned short spn84  __attribute__((packed)); /*!< Wheel based vehicle speed, 1/256km/h, 0 offset */
...
struct spns65270 {
    ...
    unsigned char  spn102; /*!< Boost pressure, 2kPa/bit, 0 offset - bar line inside engine speed display */
    unsigned char  spn105; /*!< Intake manifold 1 temperature, 1C/bit, -40C offset */
 ...
 *
 * Broadcast message:
 * 65250 - Transmission configuration TC
 * 65280 (propritary) - 28B! -> 0x17(cluster)
 */
/**
 * \struct spns65250 (FEE2)
...
/**
  * \struct spns65223 (FEC7)
  * \brief Electronic Transmission Controller 3 - ETC3
  *
  * Transmission on request; length 8B; default priority 6
  */
struct spns65223 {
    unsigned char spns59     ; /*!< Shift finger gear position, 0.4%/bit, 0 offset */
    unsigned char spns60     ; /*!< The current position of the shift finger, 0.4%/bit, 0 offset */
    unsigned char spns780 : 2; /*!< Shift Finger Neutral Indicator, 00-off, 01-on */
    unsigned char spns781 : 2; /*!< Shift Finger Engagement Indicator */
    unsigned char spns782 : 2; /*!< Shift Finger Center Rail Indicator */
    unsigned char u0      : 2; /*!<  */
    unsigned char spns772 : 2; /*!< Shift Finger Rail Actuator 1 */
    unsigned char spns773 : 2; /*!< Shift Finger Gear Actuator 1 */
    unsigned char spns783 : 2; /*!< Transmission High Range Sense Switch */
    unsigned char spns784 : 2; /*!< Transmission Low Range Sense Switch */
    unsigned char spns768 : 2; /*!< Range High Actuator */
    unsigned char spns769 : 2; /*!< Range Low Actuator */
    unsigned char spns770 : 2; /*!< Splitter Direct Actuator */
    unsigned char spns771 : 2; /*!< Splitter Indirect Actuator */
    unsigned char spns788 : 2; /*!< Clutch Actuator */
    unsigned char spns740 : 2; /*!< Lockup Clutch Actuator */
    unsigned char spns786 : 2; /*!< Defuel Actuator */
    unsigned char spns787 : 2; /*!< Inertia Brake Actuator */
    unsigned char u1[2];
};
/**
 * \struct spns65272 (FEF8)
 * \brief Transmission Fluids - TF
 *
 * Transmission 1 s; length 8B; default priority 6
 */
struct spns65272 {
    unsigned char  spn123; /*!< Clutch Pressure, 0.16kPa/bit, 0 offset */
    unsigned char  spn124; /*!< Transmission Oil Level, 0.4%/bit, 0 offset */
    unsigned char  spn126; /*!< Transmission Filter Differential Pressure, 2kPa/bit, 0 offset */
    unsigned char  spn127; /*!< Transmission Oil Pressure, 16kPa/bit, 0 offset */
    unsigned short spn177; /*!< Transmission Oil Temperature, 0.03125C/bit, -273C offset */
    unsigned char  u0[2] ; /*!< not used */
};
...
struct spns61441 {
    ...
    unsigned char spn521     ; /*!< Brake Pedal Position 0.4%/bit, 0 offset*/
    ...
    unsigned char spn973     ; /*!< Engine Retarder Selection 0.4%/bit, 0 offset*/
...
/**
 * \struct spns65196 (FEAC)
 * \brief Wheel Brake Lining Remaining Information - EBC4
 *
 * Transmission on request; length 8B; default priority 7
 */
struct spns65196 {
    unsigned char spn1099; /*!< Brake Lining Remaining, Front Axle, Left Wheel, 0.4%/bit, 0 offset */
    unsigned char spn1100; /*!< Brake Lining Remaining, Front Axle, Right Wheel, 0.4%/bit, 0 offset */
    unsigned char spn1101; /*!< Brake Lining Remaining, Rear Axle #1, Left Wheel, 0.4%/bit, 0 offset */
    unsigned char spn1102; /*!< Brake Lining Remaining, Rear Axle #1, Right Wheel, 0.4%/bit, 0 offset */
    unsigned char spn1103; /*!< Brake Lining Remaining, Rear Axle #2, Left Wheel, 0.4%/bit, 0 offset */
    unsigned char spn1104; /*!< Brake Lining Remaining, Rear Axle #2, Right Wheel, 0.4%/bit, 0 offset */
    unsigned char spn1105; /*!< Brake Lining Remaining, Rear Axle #3, Left Wheel, 0.4%/bit, 0 offset */
    unsigned char spn1106; /*!< Brake Lining Remaining, Rear Axle #3, Right Wheel, 0.4%/bit, 0 offset */
};
 ...
 *
 * Broadcast message:
 * 65249 - Retarder configuration RC
 */
/**
 * \struct spns65249 (FEE1)
 * \brief Retarder configuration RC
 *
...
/**
 * \struct spns65275 (FEFB)
 * \brief Retarder fluids - RF
 *
 * Transmission 1 s; length 8B; default priority 6
 */
 struct spns65275 {
     unsigned char spn119; /*!< Hydraulic Retarder Pressure, 16kPa/bit, 0 offset */
     unsigned char spn120; /*!< Hydraulic Retarder Oil Temperature, 1C/bit, -40C offset */
     unsigned char u0[6]; /*!< padding, filled with 0xFF */
 };
 ...
 * 65441, 65442, 65443, 65444 (propritary)
 */
/**
 * \struct spns65276 (00FEFC)
...
struct spns65266 {
    ...
    unsigned short spn185; /*!< Average Fuel Economy, 1/512km/kg/bit, 0 offset */
 ...
 * 65254 Time/Date - TD
 * Broadcast:
 * 65131 Driver's Identification - DI
 * 65260 Vehicle Identification - VI
 */
/**
 * \struct spns65132 (FE6C)
...
struct spns65132 {
    ...
    unsigned short spn1623;     /*!< Tachograph output shaft speed, 0.125rpm/bit, 0 offset */
    unsigned short spn1624;     /*!< Tachograph vehicle speed, 1/256km/h/bit, 0 offset */
};
/**
 * \struct spns65217 (FEC1)
 * \brief High Resolution Vehicle Distance - VDHR
 *
 * Transmission 1 s; length 8B; default priority 6
 */
struct spns65217 {
    unsigned int spn917; /*!< High Resolution Total Vehicle Distance 5m/bit, 0 offset*/
    unsigned int spn918; /*!< High Resolution Trip Distance, 5m/bit, 0 offset */
};
/**
 * \struct spns65254 (FEE6)
 * \brief Time/Date - TD
 *
 * Transmission on request; length 8B; default priority 6
 */
...
/**
 * \struct spns65131 (FE6B)
 * \brief Driver's Identification - DI
 */
struct spns65131 {
    unsigned char spn1625[18]; /*!< driver identification number, last character '*' */
};
/**
 * \struct spns56832 (DE00)
 * \brief Reset - RESET
 * Transmission when needed; length 8B; default priority 7
 */
struct spns56832 {
    unsigned char spn988 : 2; /*!< Trip Group 1 */
    unsigned char spn989 : 2; /*!< Trip Group 2 - Proprietary */
    unsigned char u0     : 4; /*!< not used */
    unsigned char spn1584   ; /*!< Service Component Identification */
    unsigned char spn1211: 2; /*!< Service Component Identification */
    unsigned char u1     : 6; /*!< not used */
    unsigned char u2[5]     ; /*!< not used */
};

/**
 * \brief The following structures have no clearly defined purpose.
 */
/**
 * \struct spns65088 (FE40)
